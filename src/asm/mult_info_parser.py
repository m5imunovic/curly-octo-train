...
def partition_mult_info_edges(mult_info: dict[str, int]) -> tuple[set, set]:
    """Split edges into correct and incorrect based on multiplicity. Multiplicity greater
    than 0 means that the edge is real and erroneous otherwise.

    Args:
        mult_info (dict[str, int]): multiplicity dict (as generated by parse_mult_info)

    Returns:
        tuple[set, set]: partioning of the correct/incorrect edges
    """
    incorrect_edges = set()
